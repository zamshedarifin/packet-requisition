                            ...
                            <table id="datatablesSimple">
                                ...
                                @forelse($requisitionData as $k=>$data)
                                    <tr>
                                        ...
                                        <td>
                                            @if($data->urban_truth_packet_quantity)
                                                <span style="font-weight: bold;"> {{$data->urban_truth_packet_quantity}} </span>
                                            @else
                                                --
                                            @endif
                                        </td>
                                        <td>
                                            ...
                                            @else
                                                <span class="bg-warning p-1 rounded text-white">Pending</span>
                                            @endif
                                        </td>
                                        <td>
                                            @if(Auth::guard('admin')->user()->role_id == 1)
                                           <a href="{{route('admin.requsition-details',$data->id)}}" class="bg-primary p-1 rounded text-white text-decoration-none">Details</a>
                                            @else
                                            <a href="{{route('admin.requsition-view',$data->id)}}" class="bg-primary p-1 rounded text-white text-decoration-none">View</a>
                                            @endif
                                        </td>
                                    </tr>
                                @empty
