                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="container mt-5">
                            ...
                            @endif
                            <form method="POST" action="{{route('admin.requsition-view',$requisitionData->id)}}">
                                @csrf
                                <div class="row">
                                    <div class="col">
                                        <div class="card">
                                            <div class="card-header">
                                                <span class="text-primary" style="font-weight: bold">Pride Requisition List</span>
                                            </div>
                                            <div class="card-body">
                                                <div class="row mt-3">
                                                    <div class="col mt-4">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" disabled value="{{$requisitionData->pride_approved_quantity_small}}" name="pride_packet_approve_quantity_small" id="pride_packet_quantity_small" placeholder="Small">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mt-2">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" disabled class="form-control" value="{{$requisitionData->pride_approved_quantity_medium}}" name="pride_packet_approve_quantity_medium" id="pride_packet_quantity_medium" placeholder="Medium">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mt-2">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" disabled  class="form-control" value="{{$requisitionData->pride_approved_quantity_large}}" name="pride_packet_approve_quantity_large" id="pride_packet_quantity_large" placeholder="Large">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col">
                                        <div class="card">
                                            <div class="card-header">
                                                <span class="text-success" style="font-weight: bold">Urban Truth Requisition</span>
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col mt-4">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" disabled class="form-control" value="{{$requisitionData->urban_truth_approved_quantity}}" name="urban_truth_approve_quantity" id="urban_truth_packet_quantity" placeholder="Quantity">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col">
                                        <div class="card">
                                            <div class="card-header">
                                                <span class="text-danger" style="font-weight: bold">Challan Number</span>
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <label class="" for="pride_packet_quantity_small">Enter Challan Number: <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-md-10">
                                                        <input type="text"  value="{{$requisitionData->challan_number}}" class="form-control" name="challan_number" id="challan_number" placeholder="Challan Number">
